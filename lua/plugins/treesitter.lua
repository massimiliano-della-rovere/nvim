    ...
    config = function()
      require("nvim-treesitter").setup({
        ensure_installed = {
          ...
          "c", "css", "javascript", "python",
          "query", "sql", "typescript", "unison", "vimdoc",
        },
        auto_install = true,
  ...
  -- ============================================================
  {
    ...
    config = function()
      ...
      vim.api.nvim_create_autocmd("ColorScheme", {
        ...
        callback = function()
          ...
          vim.api.nvim_set_hl(0, "TreesitterContext",
            { link = "CursorLine", default = false })
          vim.api.nvim_set_hl(0, "TreesitterContextLineNumber",
            { link = "CursorLineNr", default = false })
          vim.api.nvim_set_hl(0, "TreesitterContextSeparator",
            { link = "Comment", default = false })
        end,
      })
      ...
      vim.keymap.set("n", "[C",
        ...
        { desc = "TSContext: jump to context" })
    end,
  },
